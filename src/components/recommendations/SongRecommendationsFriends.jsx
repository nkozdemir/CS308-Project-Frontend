...
const SongRecommendationsFriends = () => {
  ...
  const getSongRecommendations = async () => {
    try {
      ...
      const response = await axiosInstance.post('/recommendation/friend/rating');
  ...
  return (
    <div>
      <div className='flex items-center justify-center mb-8'>
        <h2 className='font-bold text-2xl'>Based On Your Friends' Ratings</h2>
        <button
          onClick={() => {
            setNoRecommendations(false);
...
export default SongRecommendationsFriends;