                            ...
                            <tbody>
                                {filteredFriends.map((result) => (
                                    <tr key={result.FriendInfo.UserID} className='hover'>
                                        ...
                                        <td className='font-bold'>{`@${result.FriendInfo.Email.split('@')[0]}`}</td>
                                        <td className='font-bold'>{result.FriendInfo.Name}</td>
                                        <td>
                                            <button 
                            ...
                            <tbody>
                                {searchResults.map((result) => (
                                    <tr key={result.UserID} className='hover'>
                                        ...
                                        <td className='font-bold'>{`@${result.Email.split('@')[0]}`}</td>
